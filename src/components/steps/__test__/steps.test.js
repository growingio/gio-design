...
describe('Steps', () => {
  describe('render', () => {
    ...
    it('renders correctly ---- modal', () => {
      const wrapper = render(
        <Steps type="modal" size="not-exist">
          <Step key="1" title="title1" description="description1" />
          <Step key="2" title="title2" description="description2" />
          <Step key="3" title="title3" description="description3" />
          <Step key="4" title="title4" description="description4" />
    ...
    it('renders correctly ---- modal middle', () => {
      const wrapper = render(
        <Steps type="modal" size="middle">
          <Step key="1" title="title1" description="description1" />
          <Step key="2" title="title2" description="description2" />
          <Step key="3" title="title3" description="description3" />
          <Step key="4" title="title4" description="description4" />
    ...
    it('renders correctly ---- modal small', () => {
      const wrapper = render(
        <Steps type="modal" size="small">
          <Step key="1" title="title1" description="description1" />
          <Step key="2" title="title2" description="description2" />
          <Step key="3" title="title3" description="description3" />
          <Step key="4" title="title4" description="description4" />
