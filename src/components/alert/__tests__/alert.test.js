...
describe('Alert snapshots.', () => {
  it('should match alert base snapshot.', () => {
    const wrapper = render(<Alert type="success" message="Success Text" />);
    expect(wrapper).toMatchSnapshot();
  });

  it('icon by self.', () => {
    const wrapper = render(<Alert icon={<TagOutlined />} showIcon />);
    expect(wrapper).toMatchSnapshot();
  });
  ...
  it('should show icons', () => {
    const wrapper = render(
      <div>
        ...
        <Alert message="Default Text" showIcon />
        ...
        <Alert message="Default Text" showIcon size="small" />
      </div>
    );
    expect(wrapper).toMatchSnapshot();
  });
  ...
  it('the colseText should be useful', () => {
    const wrapper = mount(<Alert type="success" message="Success Text" closeable colseText="Close Now" />);
    wrapper.find('.gio-alert-closeIcon').simulate('click');
  ...
  it('should be stable', () => {
    const wrapper = render(
      <div>
        ...
        <Alert type="warning" description="Warning Description" size="small" />
        <Alert type="error" description="Error Description" size="small" />
      </div>
    );
    expect(wrapper).toMatchSnapshot();
  });
