...
describe('Testing List', () => {
  ...
  it('render List items with suffix prefix', () => {
    const options = [
      { label: 'List Item 1', value: '1', prefix: <span>$</span>, suffix: <span>¥</span> },
  ...
  it('render List items with context suffix prefix', () => {
    ...
    render(
      <List prefix={() => <span>$</span>} suffix={() => <span>¥</span>} options={options} itemStrategy="absolute" />
    );
    expect(screen.queryByTestId('list')).toBeTruthy();
  ...
  it('render List with collapse', () => {
    ...
    render(
      <List collapse={2} onClick={mockClick}>
        <List.Item value="1">List Item 1</List.Item>
        <Item disabled value="2">
          List Item 2
        </Item>
  ...
  it('test change event when model=multiple', () => {
    ...
    const Demo = () => {
      ...
      return (
        <List model="multiple" max={3} value={value} onChange={handleChange} onMultipleOverflow={mockMultipleOverflow}>
          <Item value="1">List Item 1</Item>
          <Item disabled value="2">
            List Item 2
          </Item>
