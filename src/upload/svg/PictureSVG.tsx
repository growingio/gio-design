...
function PictureSVG(props: IconProps) {
  return (
    // eslint-disable-next-line react/jsx-props-no-spreading
    <svg width={51} height={37} viewBox="0 0 51 37" {...props}>
      <rect width={51} height={37} rx={3} fill="#7B9CFF" />
      <rect x={3} y={2} width={45} height={33} rx={3} fill="#EFF3FF" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="#B8D1FF"
      />
      <circle cx={11.5} cy={10.5} r={3.5} fill="#B8D1FF" />
    </svg>
  );
}
