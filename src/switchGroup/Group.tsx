...
const InnerGroup: React.ForwardRefRenderFunction<HTMLDivElement, ISwitchGroupProps> = (
  ...
  const { className, style, disabled, defaultValue, value, onChange, children, options, size } = props;
...
const SwitchGroup = WithRef<HTMLDivElement, ISwitchGroupProps>(InnerGroup);
