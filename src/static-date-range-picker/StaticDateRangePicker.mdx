...
<Canvas>
  <Story id="upgraded-staticdaterangepicker--basic" />
</Canvas>
...
<Canvas>
  <Story id="upgraded-staticdaterangepicker--disabled-date" />
</Canvas>
...
<Canvas>
  <Story id="upgraded-staticdaterangepicker--default-view-date" />
</Canvas>
