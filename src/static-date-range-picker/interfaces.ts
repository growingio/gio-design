...
export type StaticDateRangePickerLocale = Omit<Locale, 'locale'>;

export interface StaticDateRangePickerProps extends CommonProps, Pick<DatePickerProps, 'disabledDate'> {
  /**
   * 默认选择的日期
   */
   ...
   * 国际化配置
   */
  locale?: StaticDateRangePickerLocale;
  /**
   * 鼠标进入日期单元格的触发事件的回调
   *
