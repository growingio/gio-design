...
export default function CardPage() {
  ...
  return (
    <>
      ...
      <p>{formatMessage({ defaultMessage: '卡片内包含关于同一事物的内容和行动。' })}</p>
