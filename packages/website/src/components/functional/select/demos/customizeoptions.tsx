...
const CustomizeOptions = (): React.ReactNode => {
  return (
    <>
      <div>
        <Select options={options} size="large" style={{ width: 140 }} placeholder="请选择" listRowHeight={50}>
          <Select.Group label="Manager" value="2">
            <Select.Option value="jack">
              <div style={{ height: '100px', textAlign: 'center', lineHeight: '100px' }} className="customizeoptions">
        ...
        <div style={{ marginTop: '16px' }}>
          <Select options={[]} style={{ width: 140 }} placeholder="请选择">
