...
function SvgTableChartOutlined(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoSvgTableChartOutlined = React.memo(SvgTableChartOutlined);
export default MemoSvgTableChartOutlined;
