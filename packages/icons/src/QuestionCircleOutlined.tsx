...
function SvgQuestionCircleOutlined(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoSvgQuestionCircleOutlined = React.memo(SvgQuestionCircleOutlined);
export default MemoSvgQuestionCircleOutlined;
