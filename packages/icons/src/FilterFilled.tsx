...
function SvgFilterFilled(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 14 14" width="1em" height="1em" {...props}>
      <defs>
        <style />
      </defs>
      <g id="filter-filled_svg__\u56FE\u5C42_2" data-name="\u56FE\u5C42 2">
        <g id="filter-filled_svg__\u56FE\u5C42_1-2" data-name="\u56FE\u5C42 1">
          <path
...
const MemoSvgFilterFilled = React.memo(SvgFilterFilled);
export default MemoSvgFilterFilled;
