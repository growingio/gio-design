...
function SvgLeftDoubleOutlined(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoSvgLeftDoubleOutlined = React.memo(SvgLeftDoubleOutlined);
export default MemoSvgLeftDoubleOutlined;
