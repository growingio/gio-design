...
function SvgQuestionCircle(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 14 14" width="1em" height="1em" {...props}>
      ...
      <g id="question-circle_svg__\u56FE\u5C42_2" data-name="\u56FE\u5C42 2">
        <g id="question-circle_svg__\u56FE\u5C42_1-2" data-name="\u56FE\u5C42 1">
          <path
            ...
            fill="#323333"
            id="question-circle_svg__question-circle"
          />
        </g>
      </g>
    </svg>
...
const MemoSvgQuestionCircle = React.memo(SvgQuestionCircle);
export default MemoSvgQuestionCircle;
