...
export default () => {
  ...
  return (
    <div className="button-demo">
      <div className="list">
        <div className="item">
          <Button type="text" icon={<FilterOutlined />} size="large" />
          <Button type="secondary" icon={<FilterOutlined />} size="large" />
        </div>
        <div className="item">
          <Button type="text" disabled icon={<FilterOutlined />} size="large" />
          <Button type="secondary" disabled icon={<FilterOutlined />} size="large" />
        </div>
        <div className="item">
          <Button type="text" disabled icon={<FilterOutlined />} size="large" loading />
      ...
      <div className="list">
        ...
        <div className="item">
          <Button type="text" disabled icon={<FilterOutlined />} />
          <Button type="secondary" disabled icon={<FilterOutlined />} />
        </div>
        <div className="item">
          <Button type="text" disabled icon={<FilterOutlined />} loading />
          <Button type="secondary" disabled icon={<FilterOutlined />} loading />
        </div>
        <div className="item">
          <Button type="text" icon={<FilterOutlined />} loading={loadings[3]} onClick={() => enterLoading(3)} />
      ...
      <div className="list">
        ...
        <div className="item">
          <Button type="text" disabled icon={<FilterOutlined />} size="small" />
          <Button type="secondary" disabled icon={<FilterOutlined />} size="small" />
        </div>
        <div className="item">
          <Button type="text" disabled icon={<FilterOutlined />} size="small" loading />
      ...
      <div className="list">
        <div className="item">
          <Button type="text" icon={<FilterOutlined />} mini />
          <Button type="secondary" icon={<FilterOutlined />} mini />
        </div>
        <div className="item">
          <Button type="text" disabled icon={<FilterOutlined />} mini />
          <Button type="secondary" disabled icon={<FilterOutlined />} mini />
        </div>
        <div className="item">
          <Button type="text" disabled icon={<FilterOutlined />} mini loading />
          <Button type="secondary" disabled icon={<FilterOutlined />} mini loading />
        </div>
        <div className="item">
          <Button type="text" icon={<FilterOutlined />} loading={loadings[5]} mini onClick={() => enterLoading(5)} />
          <Button
            type="secondary"
            icon={<FilterOutlined />}
            loading={loadings[6]}
